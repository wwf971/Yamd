 ...
 */
const YamdNodeLaTeX = ({ nodeId, getNodeDataById, getAssetById, parentInfo }) => {
      ...
      <div className="yamd-latex-block yamd-latex-raw" id={nodeData.htmlId}>
        ...
        <div className="yamd-latex-caption">
          <span className="yamd-latex-label">
            ...
            {LATEX_SETTINGS.defaultCaptionTitle}.
          </span>
  ...
  const asset = getAssetById(nodeData.assetId);
  ...
  return (
    <div className={`yamd-latex-block ${nodeClass}`} id={nodeData.htmlId}>
      <div 
      ...
      <div className="yamd-latex-caption">
        <span className="yamd-latex-label">
          ...
          {asset?.captionTitle || LATEX_SETTINGS.defaultCaptionTitle}
