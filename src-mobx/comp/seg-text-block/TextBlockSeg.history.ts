...
// History version diff handler, same policy as TextSeg: a text-only change is
// described as one splice against the base version. Any other data change
// declines, so the doc-level generic field diff takes over.
registerCompDataDiffHandler('TextBlockSeg', {
